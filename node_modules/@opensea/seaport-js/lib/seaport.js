...
class Seaport {
     ...
     */
    _formatOrder(signer, offerer, exactApproval, { conduitKey = this.defaultConduitKey, zone = ethers_1.ethers.constants.AddressZero, startTime = Math.floor(Date.now() / 1000).toString(), endTime = constants_1.MAX_INT.toString(), offer, consideration, counter, allowPartialFills, restrictedByZone, fees, domain, salt, }) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
    ...
    signOrder(orderComponents, accountAddress) {
        return __awaiter(this, void 0, void 0, function* () {
            const signer = this._getSigner(accountAddress);
            const domainData = yield this._getDomainData();
            const signature = yield signer._signTypedData(domainData, constants_1.EIP_712_ORDER_TYPE, orderComponents);
            // Use EIP-2098 compact signatures to save gas.
            return ethers_1.ethers.utils.splitSignature(signature).compact;
        });
    }
    /**

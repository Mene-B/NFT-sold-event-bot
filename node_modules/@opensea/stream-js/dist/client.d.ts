import { ClientConfig, BaseStreamMessage, EventType, ItemMetadataUpdate, ItemListedEvent, ItemSoldEvent, ItemTransferredEvent, ItemReceivedBidEvent, ItemReceivedOfferEvent, ItemCancelledEvent, CollectionOfferEvent, TraitOfferEvent, Callback, OrderValidationEvent } from './types';
export declare class OpenSeaStreamClient {
    ...
    onOrderInvalidate: (collectionSlug: string, callback: Callback<OrderValidationEvent>) => () => void;
    onOrderRevalidate: (collectionSlug: string, callback: Callback<OrderValidationEvent>) => () => void;

...
const CHAIN_TO_NAME = {
    [types_1.Chain.Mainnet]: "ethereum",
    [types_1.Chain.Goerli]: "goerli",
};
...
const getBuildCollectionOfferPayload = (offererAddress, quantity, collectionSlug) => {
    return {
...
const deserializeOrder = (order) => {
    return {
        ...
        currentPrice: ethers_1.BigNumber.from(order.current_price),
